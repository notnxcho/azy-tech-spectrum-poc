...
const techs = [
  ...
  {name: 'Infrared telescopic intelligence deployable satellite', minScore: 7, maxScore: 8},
  {name: 'Armored Vehicle', minScore: 4, maxScore: 7},
]
            ...
            {techs.map((tech, index) => {
              return (
                <div className='tech-row-wrap'>
                  <div className='spectrum-region' style={{gridColumn: `${tech.minScore} / ${tech.maxScore + 1}`, alignItems: `${tech.minScore > 5 ? 'flex-end' : 'flex-start'}`}}>
